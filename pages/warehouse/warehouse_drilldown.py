    ...
    dbc.Row([
        dbc.Col([
            dbc.Row([
                ...
                dcc.Dropdown(id='factory_dropdown_drilldown',
            ...
            dbc.Row([
                ...
                dcc.Dropdown(id='product_dropdown_drilldown',
        ...
        ], id='drilldown_sidebar', width=2),


        dbc.Col([
            dbc.Row([
                dcc.Graph(figure={}, id='line_by_time_stack')
            ]),
...
@callback(
    [Output('line_by_time_stack','figure'),
     ],
#Output('line_by_time_concat','figure')
    [Input('factory_dropdown_drilldown','value'),
     Input('product_dropdown_drilldown','value'),
