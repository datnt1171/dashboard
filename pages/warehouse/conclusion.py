...
dash.register_page(__name__, path="/warehouse_conclusion")
...
layout = dbc.Container([
    dbc.Row([
        ...
        dbc.Col([
            ...
            dcc.DatePickerRange(
            id='target_mom_day_range_conclusion',
    ...
    dbc.Row([
        html.H3(id="order_title", className='conclusion-title'),
        html.H5(id="order_conclude_no_timber", className='conclusion-title'),
        html.H5(id="order_conclude", className='conclusion-title'),
        html.H3(id="sales_title", className='conclusion-title'),
        html.H5(id="sales_conclude_no_timber", className='conclusion-title'),
        html.H5(id="sales_conclude", className='conclusion-title')
    ]),
    ...
    dbc.Row([
        ...
        dbc.Col([
            dcc.Graph(figure={}, id='fig_sales_same_month')
        ], width=8) 
    ]),
...
@callback(
    [Output('order_title','children'),
     Output('order_conclude_no_timber','children'),
     Output('order_conclude_no_timber','style'),
     Output('order_conclude','children'),
     Output('order_conclude','style'),

     Output('sales_title','children'),
     Output('sales_conclude_no_timber','children'),
     Output('sales_conclude_no_timber','style'),
     Output('sales_conclude','children'),
     Output('sales_conclude','style'),
     
     Output('fig_sales_same_month','figure')],
    
    [Input('mom_day_range_conclusion','start_date'),
     Input('mom_day_range_conclusion','end_date'),
     Input('target_mom_day_range_conclusion','start_date'),
     Input('target_mom_day_range_conclusion','end_date')]
)
